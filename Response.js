export default {
  ...
  searchInformation: {
    ...
    totalResults: "51300000",
    formattedTotalResults: "51,300,000",
  },
  items: [
    {
    ...
    {
      kind: "customsearch#result",
      title: "Hello Group Inc (MOMO : NASDAQ) Stock Price & News - Google ...",
      htmlTitle:
        "<b>Hello</b> Group Inc (MOMO : NASDAQ) Stock Price &amp; News - Google ...",
      link: "https://www.google.com/finance/quote/MOMO:NASDAQ",
      displayLink: "www.google.com",
      snippet:
        "Get the latest Hello Group Inc (MOMO) real-time quote, historical performance, charts, and other financial information to help you make more informed trading ...",
      htmlSnippet:
        "Get the latest <b>Hello</b> Group Inc (MOMO) real-time quote, historical performance, charts, and other financial information to help you make more informed trading&nbsp;...",
      formattedUrl: "https://www.google.com/finance/quote/MOMO:NASDAQ",
      htmlFormattedUrl: "https://www.google.com/finance/quote/MOMO:NASDAQ",
      pagemap: {
        cse_thumbnail: [
          {
        ...
        metatags: [
          {
            ...
            "twitter:card": "summary",
            "twitter:title":
              "Hello Group Inc (MOMO : NASDAQ) Stock Price & News - Google Finance",
            "apple-mobile-web-app-title": "Google Finance",
            "og:title":
              "Hello Group Inc (MOMO : NASDAQ) Stock Price & News - Google Finance",
            "og:image:height": "402",
            "og:description":
              "Get the latest Hello Group Inc (MOMO) real-time quote, historical performance, charts, and other financial information to help you make more informed trading and investment decisions.",
            "twitter:image":
            ...
            "og:url": "https://www.google.com/finance/quote/MOMO:NASDAQ",
          },
        ],
        cse_image: [
          {
        ...
        metatags: [
          {
            ...
            searchtype: "analysis",
            "csrf-token":
              "ONK6qW5JSlDmSKuWq3aut4Bp7Qs3FKnjwNBmlW5yhgf1ck7QrD00cNPjG4jKcKeHedOMDNnlkvs_3absH6dYYA",
            pubdate: "20200428",
            "og:type": "article",
            author: "Maria Nugent",
            "og:title":
